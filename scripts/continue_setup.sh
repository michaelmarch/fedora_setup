...
dconf write /org/gnome/desktop/peripherals/mouse/speed "-0/47"
dconf write /org/gnome/desktop/media-handling/autorun-x-content-open-folder "[]"
dconf write /org/gnome/desktop/media-handling/autorun-x-content-ignore "[]"
dconf write /org/gnome/desktop/background/picture-uri "'file://$HOME//config/wallpaper/jpg'"
dconf write /org/gnome/desktop/background/picture-uri-dark "'file://$HOME/.config/wallpaper.jpg'"
